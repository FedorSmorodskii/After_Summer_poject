"""
Подключаем сессии и передаем их в CRUD
"""
...
@router.post(
    ...
    status_code=status.HTTP_201_CREATED  # Указываем статус создания нового продукта
)  # .post для создания нового товара в БД | response_model для проверки типа
